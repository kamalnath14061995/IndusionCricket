...
@NoArgsConstructor
@AllArgsConstructor
public class GroundStaffRegistrationDTO {
    ...
    @NotBlank(message = "Background details are required")
    @Size(max = 2000, message = "Background details must not exceed 2000 characters")
